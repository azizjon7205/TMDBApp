...
import com.example.tmdbapp.repository.TMDBRepositoryImpl
...
@HiltViewModel
class TVShowsViewModel @Inject constructor (private val tmdbRepositoryImpl: TMDBRepositoryImpl) : ViewModel() {
...
//        _tvShowsState.value = ViewState.Loading()
        ...
        try {
            val response = tmdbRepositoryImpl.getPopularShows()
